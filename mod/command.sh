...
#info
DESCRIPTION="This script will install TMC Configuration for Australia & New Zealand. TMC set to 1024"
...
cat /mnt/app/navigation/resources/app/vw/aus/version-cfg.txt

echo Copy paytmc*.json to system

## We probably only need to do this for vw aus but doing it for all to make sure. 
